...
log_file_path = os.path.join(log_dir,'feature_engg.logs')
...
#not to hard code the parameters that's why added yaml 
...
def apply_tfidf(train_data:pd.DataFrame,test_data:pd.DataFrame,max_features = int) -> tuple:
    ...
    try:
        ...
        logger.debug('tfidf applied and transformed data')
